function partial_order = determine_elim_constraints(pnet, onodes)
% DETERMINE_ELIM_CONSTRAINTS Determine what the constraints are (if any) on the elimination ordering.
% partial_order = determine_elim_constraints(pnet, obs_nodes)
%
...
pot_type = determine_pot_type(onodes, pnet.cnodes, pnet.dag);
