...
for ll=5:10           %pour fixer les levels
...
%---------------------------------------------------------------------------------------
    ...
    tic; [Bel_Cdt_new] = global_propagation(engine, evidence_new, [], [], 0,  'n_best', 'neighbors'); t2=toc;  %si on veut appeler cette procedure avec neighbors=cs+ps
    %affichage pour A
    Bel_Cdt_new
